...
Chi-square test to evaluate group differences.
...
```
Descriptive findings revealed noticeable gaps across both groups. One fourth of the students without anxiety felt depressed. On the contrary, nearly half of the anxious students (18 out of 34) reported low mood. That’s more than twice the proportion. Those struggling with worry showed a higher chance of depression. 

A chi-square check showed the gap wasn’t due to chance, χ²(1) = 6.40, p = .0114, so in this situation, mood struggles tended to show up together.

The logistic regression found that anxious students were more likely to say they felt depressed more than triple the chance (OR = 3.31, 95% CI [1.40, 8.03], p = .007). Instead of looking at each result alone, putting together the averages, test outcomes, or even the model patterns show how strongly anxiety ties to depression, no matter the approach.
```{r plot}
