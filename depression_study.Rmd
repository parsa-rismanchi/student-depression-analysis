...
A two-proportion test, reported as a chi-squared statistic, showed that this difference was unlikely due to chance, $\chi^2$
 (1) = 6.40, p = .0114.
...
```{r plot, fig.width=5.5, fig.height=4, fig.align="center"}
