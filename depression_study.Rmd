---
title: " Investigating Depression in University Students: The Role of Anxiety"
...
chi_res   <- chisq.test(cont_table, correct = FALSE)
chi_value <- round(unname(chi_res$statistic), 2)
p_chi     <- format.pval(chi_res$p.value, digits = 3, eps = .001)
...
Chi-square test of independence (2×2 contingency table; no continuity correction) to evaluate group differences.
...
A chi-square test of independence showed that this difference was unlikely due to chance, $\chi^2$ (1) = `r chi_value`, p = `r p_chi`.  
